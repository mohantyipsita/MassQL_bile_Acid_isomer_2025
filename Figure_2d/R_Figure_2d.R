...
person_colors <- c(
  "FD003" = "#431853",  # Light Yellow
  "FD028" = "#482C79",  # Soft Yellow
  "FD017" = "#3E4989",  # Yellow
  "FD013" = "#31688E",  # Golden Yellow
  "FD024" = "#27828E",  # Light Orange
  "FD006" = "#1C9E89",  # Orange-Red
  "FD022" = "#75C15B",  # Red-Orange
  "FD004" = "#B7D435",  # Bright Red
  "FD001" = "#FCE61F"   # Dark Red
)
...
T2_values <- df_long_T2T3$log_peak_area[df_long_T2T3$timepoint == "T2"]
T3_values <- df_long_T2T3$log_peak_area[df_long_T2T3$timepoint == "T3"]

# Perform the Wilcoxon signed-rank test - as the variables are dependent
wilcox_test_result <- wilcox.test(T2_values, T3_values, paired = TRUE)
